...
function rating_selection(star_divs) {

   for (star_div of star_divs) {
      var official_rating = $(star_div).attr('name')
      console.log(official_rating)
      var stars = $(star_div).find('path')

      stars.each(function( index, element ) {

       $( element ).attr('d', colorFilled);
       star_wrap = $(this).parent().parent();
       if ( star_wrap.hasClass(official_rating)) {
         return false;
       }
     });
    }
